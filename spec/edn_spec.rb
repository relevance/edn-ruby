...
describe EDN do
  ...
  context "static methods" do
    ...
    context "#tagout" do
      it "tags a single value with the given tag" do
        EDN.tagout("tag", 0).should == "#tag 0"
      end

      it "tags multiple values with the given tag" do
        EDN.tagout("tag", *0..9).should == "#tag #{(0..9).to_a.join(' ')}"
      end
    end
  end
